...
public class IoTPagerFragment extends IoTStarterPagerFragment {
    ...
    private void processIntent(Intent intent) {
        ...
        if (data.equals(Constants.INTENT_DATA_PUBLISHED)) {
            ...
            Log.d(TAG, "Updating status message from btooth fragment");
            TextView txtMessageView = (TextView) getActivity().findViewById(R.id.txtView_Message);
            txtMessageView.setText(app.getMsgString());
        }
